...
def print_curved_header(fp,header=""):
	...
	fp.write("""<tr><td bgcolor="#cfcfbb" valign="top"><img src="corner-top-left.gif"></td>""")
	fp.write("<td bgcolor=\"#cfcfbb\">"+header+"</td>")
	fp.write("<td bgcolor=\"#cfcfbb\" align=\"right\" valign=\"top\"><img src=\"corner-top-right.gif\"></td></tr>")
	fp.write("</td></tr>")
	
def print_curved_footer(fp):
	#fp.write("<tr><td>")
	fp.write("<tr><td valign=\"bottom\" align=\"left\"><img src=\"corner-bottom-left.gif\"></td>")
	fp.write("<td>&nbsp;</td>")
	fp.write("<td valign=\"bottom\" align=\"right\"><img src=\"corner-bottom-right.gif\"></td></tr>")
	fp.write("</td></tr>")
	fp.write("</table>")
